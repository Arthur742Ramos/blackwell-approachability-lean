...
The core argument is organized around the recurrence
...
theorem and its inner-product characterization of minimizers. No custom axiom,
unsafe declaration, or non-Mathlib dependency is used.
